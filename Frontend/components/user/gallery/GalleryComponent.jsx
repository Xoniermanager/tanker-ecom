  ...
  return (
    <>
      <div  className="py-28 max-w-7xl mx-auto flex flex-col gap-12">
        ...
        {data.map((item, index)=>(
           <div style={{backgroundImage:'url("/images/service_1.jpg")'}} className='p-6 w-full h-[450px] hover:-translate-y-3 flex items-end bg-cover bg-center bg-no-repeat group' key={index}>
