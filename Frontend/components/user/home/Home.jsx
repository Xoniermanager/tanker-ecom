      ...
      <div className="relative z-22 max-w-7xl mx-auto h-full flex items-center justify-start">
       ...
       <div className="w-3/4 flex flex-col gap-7">
        <div className="border-white border-1 w-fit text-white uppercase font-semibold flex items-center gap-2 p-1 px-2">
            ...
            <span className='text-lg'>We go global</span>
        ...
        <p className='text-white w-3/4 leading-relaxed'>Tanker Solutions is dedicated to providing the best quality cost effective solution to your fuel and dry bulk transport and delivery needs.</p>
         <div className='flex'>
