  ...
  return (
    <>
      <div style={{backgroundImage: 'url("/images/page-banner.jpg")'}} className=' w-full bg-center  bg-cover page-banner relative overflow-hidden'>
         <div className='line-wrapper relative px-6 py-22 md:py-32 lg:py-46 z-1'>
            <div className='max-w-7xl mx-auto flex flex-col items-center md:items-start gap-2 md:gap-4'>
