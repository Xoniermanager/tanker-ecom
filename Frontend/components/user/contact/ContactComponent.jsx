            ...
            <div className="w-[43%] flex flex-col gap-10">
              ...
              {listData.map((item, i) => (
                <Link
                  key={i}
                  href={"/"}
                  className="bg-white rounded-4xl p-5 px-7 flex items-center gap-8 hover:shadow-[0_0_16px_#00000012] hover:scale-103 group"
                >
          ...
          <div className="flex items-center gap-12">
            ...
            <div className="w-[57%] ">
              <form
                ...
                className="flex flex-col gap-4 bg-white rounded-xl p-10"
              >
