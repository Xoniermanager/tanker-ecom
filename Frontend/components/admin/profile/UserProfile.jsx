...
const UserProfile = ({ userData }) => {
  ...
  return (
    <>
      ...
      {showImageModal && (
        <div 
          className='fixed inset-0 bg-black/20 backdrop-blur-sm z-150 flex items-center justify-center p-4 animate-in fade-in duration-200'
          ...
          <div className="flex items-center gap-6 w-full">
            <div className="relative group cursor-pointer" onClick={() => setShowImageModal(true)}>
              <Image
                ...
                height={120}
                width={120}
                className='rounded-full h-30 w-30 object-cover border-4 border-white shadow-lg transition-transform duration-300 group-hover:scale-105'
                alt='user'
              />
