...
import { MdOutlineCloudUpload, MdCamera, MdDelete } from "react-icons/md";
...
const UpdateAdminProfile = () => {
  ...
  return (
    <div className="bg-white">
              ...
              <div className="relative inline-block">
                <div className="w-32 h-32 bg-purple-600 rounded-full flex items-center justify-center text-white text-4xl font-bold mb-4 mx-auto relative overflow-hidden ring-4 ring-purple-100 transition-all hover:ring-purple-200">
                  {hasProfileImage ? (
                    ...
                    <span>{userData?.fullName?.charAt(0)?.toUpperCase() || "A"}</span>
                  )}
                </div>
                <input
                  type="file"
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 bg-black/20 bg-opacity-50 flex items-center justify-center z-1150 p-4 backdrop-blur-sm">
