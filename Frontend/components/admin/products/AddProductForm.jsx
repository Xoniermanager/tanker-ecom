...
const AddProductForm = () => {
  ...
  const handleHighlights = () => {
    ...
    if(formData.highlights.length >= 10) return toast.info("You add maximum 10 highlights")
    setFormData((prev) => ({
      ...prev,
  ...
  const handleImageChange = (e) => {
    if(productImages.length >= 10) return toast.info('You can add maximum 10 product images')
        ...
        <div className="grid grid-cols-2 gap-5 p-5 rounded-xl bg-purple-50/50">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              onChange={handleInputChange}
              className="w-full border border-gray-300 rounded-md bg-white px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
              required
            />
          </div>
          <div className="flex flex-col gap-2">
          ...
          <div className="bg-white p-5 rounded-xl w-full grid grid-cols-2 gap-5 col-span-2">
          <div className="flex flex-col gap-2">
            <label
              htmlFor="metaTitle"
              className="flex gap-1 mb-1 text-sm font-medium text-gray-900"
