  ...
  return (
    <>
      <div className="bg-white p-7 rounded-lg flex flex-col gap-5">
        <h2 className="font-semibold text-2xl">Blog Update</h2>
        <form
        ...
        >
              ...
              {formData.thumbnail.fullPath ||
                (formData.previewUrl && (
                  <Image
                    ...
                    className="w-68 h-38 rounded-md object-cover border border-gray-300 mt-2"
                  />
                ))}
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            value={formData.content}
              onChange={(html) =>
                handleChange({ target: { name: "content", value: html } })
              }
            />
          </div>
      ...
      {formData.content && (
        <div className="bg-white p-7 rounded-lg flex flex-col gap-6">
          <h2 className="font-semibold text-2xl text-purple-950 flex items-center gap-2">
            {" "}
            <FaEye className="text-purple-500 text-lg" /> Preview
          </h2>

          <span className=" blog-contents list-disc">
