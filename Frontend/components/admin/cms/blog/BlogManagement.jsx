...
const BlogManagement = ({ formData, handleChange, handleSubmit, isLoading, errMessage, removeTag, handleTagKeyDown, addTag, tagInput, setTagInput }) => {
        ...
        <div className="grid grid-cols-2 gap-5">
          ...
          <div className="flex flex-col gap-2 col-span-1">
            ...
            <select
              ...
              onChange={handleChange}
            >
              <option value="" hidden>Select your blog categories</option>
...
/>
        ...
        <div className="grid grid-cols-2 gap-5">
          ...
          <div className="flex flex-col gap-2">
            <label htmlFor="seo.blogImage">SEO Blog Image URL</label>
            <input
  type="file"
  name="seo.blogImage"
  className="border border-gray-300 bg-white rounded-md px-5 py-3 outline-none"
  onChange={handleChange}
/>
{formData.seo.blogImage && (
  <img
    src={formData.seo.blogImage}
    alt="SEO Preview"
    className="w-40 h-24 rounded-md object-cover border border-gray-300 mt-2"
/>
)}
                ...
                <div className="col-span-2 flex justify-end">
                  <button
                    ...
                    disabled={
                      ...
                      formData.subtitle === "" ||
                      formData.thumbnail.source === "" ||
                      formData.tags.length === 0 || formData.categories.length === 0 || formData.content === "" || formData.seo.title === "" || formData.seo.description === "" || formData.seo.keywords === "" 
                    }
