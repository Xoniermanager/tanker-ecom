...
const QueryOrderTable = ({orderData, setTotalPages, totalPages, currentPage, setCurrentPage, setPageLimit, setOrderStatus, orderStatus, handleListLimit}) => {
  return (
    <div className="min-h-screen bg-[#f4f2ff] p-6">
      ...
      <div className="bg-white rounded-xl shadow-md p-4 flex flex-wrap items-center justify-between gap-4 mb-6">
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <select className="border border-gray-300 text-sm px-4 py-2 rounded-md text-gray-500" onClick={(e)=>handleListLimit(e.target.value)}>
