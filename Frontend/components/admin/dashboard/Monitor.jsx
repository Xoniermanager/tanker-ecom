      ...
      <div className='w-full flex-col flex gap-4'>
        ...
        <div className="grid grid-cols-4 gap-6">
            <div className="bg-white rounded-2xl p-6 px-8 w-full flex flex-col items-center justify-center shadow-[0_0_8px_#00000015]">
                ...
                <span className='text-sm text-gray-500 capitalize font-medium pb-1'>{dashboardData?.totalOrders?.count || 0} new packages</span>
            ...
            <div className="bg-white rounded-2xl p-6 px-8 w-full flex flex-col items-center justify-center shadow-[0_0_8px_#00000015]">
                ...
                <span className='text-sm text-gray-500 capitalize font-medium pb-1'>{dashboardData?.deliveredOrders?.count || 0} new Orders</span>
            ...
            <div className="bg-white rounded-2xl p-6 px-8 w-full flex flex-col items-center justify-center shadow-[0_0_8px_#00000015]">
                ...
                <span className='text-sm text-gray-500 capitalize font-medium pb-1'>{dashboardData?.arrivedOrders?.count || 0} Support New Cases</span>

                <div className="h-1 bg-gray-300 w-full rounded-full relative overflow-hidden">
                    <div style={{ width: `${Number(dashboardData?.arrivedOrders?.salesPercent) || 0}%` }} className={`absolute left-0 bg-cyan-400 w-[55%] z-10 h-1`}></div>
                </div>
                </div>
