    ...
    <>
      <div className='w-full flex-col flex gap-4'>
        ...
        <div className="grid grid-cols-4 gap-6">
            ...
            <Link href={'/admin/quote'} className="bg-white rounded-2xl p-6 px-8 w-full flex flex-col items-center justify-center shadow-[0_0_8px_#00000015] hover:scale-104 hover:shadow-[0_0_12px_#00000022]">
                <Image src={'/images/report-gif.gif'} height={85} width={85} alt='truck'/>
                <div className='flex flex-col gap-3 items-center w-full'>

                <h3 className='text-lg font-semibold'> Queries</h3>
                <span className='text-sm text-gray-500 capitalize font-medium pb-1'>{dashboardData?.totalQuery?.count || 0} New Queries received</span>
