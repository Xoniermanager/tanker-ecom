  ...
  return (
    <>
      <div className='pl-86 pt-26 p-6 w-full bg-violet-50 flex flex-col gap-6'>
        <QuoteTable quoteData={quoteData} setTotalPages={setTotalPages} totalPages={totalPages} currentPage={currentPage} setCurrentPage={setCurrentPage} setPageLimit={setPageLimit}/>
      </div>
    </>
  )
}
